...
export default View.extend({
  ...
  initStateFromOpts(options:Options) {
    ...
    const size = ['normal','small','large'].includes(options.size) ? options.size :Size.NORMAL
    const mode = ['shadow', 'spliter', 'vertical'].includes(options.mode) ? options.mode: Mode.SPLITER
